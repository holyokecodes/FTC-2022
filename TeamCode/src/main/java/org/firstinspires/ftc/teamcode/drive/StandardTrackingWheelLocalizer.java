...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 4.125; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 0.825; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.785; // Multiplier in the Y direction
